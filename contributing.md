...
# Contributing to Optometry

Firstly, thank you for taking an interesting in contributing! Optometry is an open-source project, and welcomes
...
Optometry is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Optometry is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.optometry:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.optometry:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/optometry` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Optometry does not use automatic code-formatting
...
development environment for all Optometry&rsquo;s users. Propensive O&Uuml; reserves the right to censure
